...
let CreateSessionsService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('HashProvider')(target, undefined, 0);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _IHashProvider.IHashProvider === "undefined" ? Object : _IHashProvider.IHashProvider]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_prisma = /*#__PURE__*/_classPrivateFieldLooseKey("prisma"), class CreateSessionsService {
  ...
  async execute({
    ...
    const user = await _classPrivateFieldLooseBase(this, _prisma)[_prisma].credential.findUnique({
      where: {
        email
      }
    });
